...
def test_gen_core_butterfly_dict_asserts():
    ...
    expected_terminal_dict = {
        ...
        ('p_bar_2', 'p_bar_3'): 8.879741738791062e-07,
        ('p_bar_3', 'p_bar_2'): 0.2852297479905831,
        ('p_bar_3', 'e_bar'): 1.9840934620783555
        }
    generated_terminal_dict = gg.gen_core_butterfly_dict(10, 3, tails=True, random_seed=1)

    assert generated_terminal_dict == expected_terminal_dict
